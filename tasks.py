...
COMMANDS: dict[str, list[list[str]]] = {
    ...
    "gate-promotion": [[PYTHON, "-m", "src.models.promotion_gate"]],
...
DESCRIPTIONS = {
    ...
    "dashboard": "abre a interface operacional de engenharia de minas",
    ...
    "gate-promotion": "aplica a politica de promocao completa",
